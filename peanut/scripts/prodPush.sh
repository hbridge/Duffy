...
ssh -i ~derek/derek-key-pair-east.pem ubuntu@prod.strand.duffyapp.com "cd /home/ubuntu/Duffy/peanut/static/smskeeper && jsx --extension jsx src/ build/ history keeper_app dashboard"
