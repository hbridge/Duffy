...
done_re = re.compile(r"\b(done|check off|sent|turned in|followed up|check it off|finished|talked|texted|txted|found|wrote|walked|worked|left|packed|cleaned|called|payed|paid|bought|did|picked|went|got|had|completed)\b", re.I)
