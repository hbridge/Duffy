...
def process(user, msg, requestDict, keeperNumber):
	...
	if step == 0:
		...
		sms_util.sendMsgs(user, [random.choice(keeper_strings.TUTORIAL_POST_NAME_AND_ZIPCODE_TEXT), random.choice(keeper_strings.TUTORIAL_STUDENT_ADD_FIRST_REMINDER_TEXT)], keeperNumber)
