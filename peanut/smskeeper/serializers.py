...
class EntrySerializer(serializers.ModelSerializer):
	...
	creator_timezone = serializers.CharField(source='creator.getTimezone', read_only=True)
	creator_digest_hour = serializers.CharField(source='creator.getDigestHour', read_only=True)
	creator_digest_minute = serializers.CharField(source='creator.getDigestMinute', read_only=True)
...
class ClassifiedMessageSerializer(serializers.ModelSerializer):
	...
	recentOutgoingMessageClasses = serializers.ListField(child=serializers.CharField(), read_only=True)
