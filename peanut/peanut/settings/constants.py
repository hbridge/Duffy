...
NOTIFICATIONS_REQUEST_PHOTOS = 16 # lets a user know that there are photos she can request
NOTIFICATIONS_SEND_REQUESTED_PHOTOS = 17 # lets a user know that someone requested photos
...
ACTION_TYPE_REQUESTED_PHOTOS = 8
