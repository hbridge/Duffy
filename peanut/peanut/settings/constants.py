...
APP_SHORTLINK_NEW_USER = 'bit.ly/swap-beta'
...
NOTIFICATIONS_SMS_URL_DICT = {
	...
	NOTIFICATIONS_UNACCEPTED_INVITE_FS : None,
	NOTIFICATIONS_PHOTO_COMMENT : None,
	NOTIFICATIONS_NEW_SUGGESTION : None,
}
...
DISTANCE_WITHIN_METERS_FOR_FINE_NEIGHBORING = 250
...
FEED_OBJECT_TYPE_RELATIONSHIP_REVERSE_FRIEND = 'friend' #UPDATE when prod build is out
FEED_OBJECT_TYPE_RELATIONSHIP_FORWARD_FRIEND = 'friend' #UPDATE when prod build is out
