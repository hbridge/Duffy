...
- (void)main
{
  @autoreleasepool {
    ...
    NSDictionary *result;
    if (self.uploadOperationType == DFPhotoUploadOperationMetadata ){
      result = [photoAdapter postPhotos:photos appendThumbnailData:NO];
    } else if (self.uploadOperationType == DFPhotoUploadOperationThumbnailData) {
